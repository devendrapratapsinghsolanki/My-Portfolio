...
export default function BackgroundCanvas({ theme = 'dark' }) {
  ...
  useEffect(() => {
    ...
    const particles = [];
    const particleCount = Math.min(Math.floor(window.innerWidth / 24), 45);
    ...
    for (let i = 0; i < particleCount; i++) {
      particles.push({
        ...
        color: isDark
          ? ['rgba(99, 102, 241,', 'rgba(2, 132, 199,', 'rgba(16, 185, 129,'][Math.floor(Math.random() * 3)]
          : ['rgba(79, 70, 229,', 'rgba(2, 132, 199,', 'rgba(5, 150, 105,'][Math.floor(Math.random() * 3)],
